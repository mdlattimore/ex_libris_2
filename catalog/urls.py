...
urlpatterns = [
    ...
    path('work_detail/<int:pk>/', views.WorkDetailView.as_view(),
         name='work_detail'),
    path('volume_list/', views.VolumeListView.as_view(), name='volume_list'),
    path('volume_detail/<int:pk>/', views.VolumeDetailView.as_view(),
         name='volume_detail'),
    ...
    path('bookset_detail/<int:pk>/', views.BookSetDetailView.as_view(),
         name='bookset_detail'),
    ...
    path('collection_detail/<int:pk>/', views.CollectionDetailView.as_view(),
