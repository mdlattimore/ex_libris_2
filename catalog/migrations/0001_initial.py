# Generated by Django 5.2.1 on 2025-10-20 00:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Catalog', 'Catalog'), ('Inventory', 'Inventory')], max_length=10)),
                ...
                ('disposition', models.CharField(blank=True, choices=[('Sold', 'Sold'), ('Donated', 'Donated'), ('Gifted', 'Gifted'), ('Discarded', 'Discarded')], max_length=30, null=True)),
                ...
                ('shipping_charged', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ...
                ('book_spotlight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='editions', to='catalog.bookspotlight')),
                ('boxset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='catalog.boxset')),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='books', to='catalog.collection')),
                ('genres', models.ManyToManyField(blank=True, related_name='book_genres', to='catalog.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookImage',
            fields=[
                ...
                ('book', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='images', to='catalog.book')),
                ('spotlight_cover', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='spotlight_images', to='catalog.bookspotlight')),
                ('boxset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='boxset_images', to='catalog.boxset')),
            ],
            options={
